...
<head>
    ...
    <meta name="description" content="Leveringsbetingelser ved køb af smykker hos MaryLou Jewellery">


    <?php include "header.html";?>
    <main>
        <!--Templates til indholdet på levering siden, som skal bruges i javascript for at hente det dynamiske indhold ved hjælp af en json fil fra wordpress-->
...
<?php include "footer.html";?>
    <script>
        ...
        async function hentJson() {
            let jsonData = await fetch("https://camilla-pedersen.dk/kea/MaryLou/wordpress/wp-json/wp/v2/pages?slug=levering");
