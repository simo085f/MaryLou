...
<head>
   <title>Returnering</title>
     ...
     <meta name="description" content="Returnering af smykker køb hos MaryLou Jewellery">



    <?php include "header.html";?>
    <main>
        <!--Template til indholdet på retur siden, som skal bruges i javascript for at hente det dynamiske indhold ved hjælp af en json fil fra wordpress-->
...
<?php include "footer.html";?>
    ...
    //Hent Json filen når DOM er loaded
        ...
        async function hentJson(){
            let jsonData = await fetch("https://camilla-pedersen.dk/kea/MaryLou/wordpress/wp-json/wp/v2/pages?slug=returnering");
